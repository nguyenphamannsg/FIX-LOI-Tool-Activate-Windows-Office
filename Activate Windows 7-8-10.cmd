...
echo Ban co muon go key Windows de tiep tuc kich hoat?
choice /c:1234 /n /m ">_         Nhan 1 de go key Windows , Nhan 2 de thoat
...
echo Supporter:%supporter% >k2.txt & echo Key:%k1% >>k2.txt & echo IID:%MyIID% >>k2.txt & echo CID:%CID% >>k2.txt & cscript slmgr.vbs /dli >>k2.txt & cscript slmgr.vbs /xpr >>k2.txt & start k2.txt & exit
